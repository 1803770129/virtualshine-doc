...
export default function ContentHighlighter({ backgroundColor="#fff5eb", textColor="black", borderColor="#fed4a4", content, emoji="🤓" }: IContentHighlighter) {
    return (
        <>
            <div className='w-full m-h-30 p-10 rounded-8 flex' style={{backgroundColor:backgroundColor,color:textColor,borderWidth:'2px',borderStyle:'solid',borderColor:borderColor}}>
